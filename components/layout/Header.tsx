...
export const Header: React.FC<HeaderProps> = ({ onToggleSidebar, onToggleTheme, currentTheme, breadcrumbs, pageTitle }) => {
    return (
        <header className="glass-panel bg-white/80 dark:bg-[#151923]/80 sticky top-4 z-20 mx-6 mt-4 rounded-xl shadow-soft border border-white/20 dark:border-white/5 flex items-center justify-between px-6 h-16 transition-all duration-200">
