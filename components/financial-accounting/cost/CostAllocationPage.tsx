...
export const CostAllocationPage: React.FC<CostAllocationPageProps> = ({ costCenters, addJournalEntry, showToast }) => {
    ...
    const [sourceCenters, setSourceCenters] = useState<Set<string>>(new Set<string>());
    const [targetCenters, setTargetCenters] = useState<Set<string>>(new Set<string>());
    ...
    const handlePost = () => {
        ...
        setStep(1);
        setSourceCenters(new Set<string>());
        setTargetCenters(new Set<string>());
        setAllocationValues({});
    };
